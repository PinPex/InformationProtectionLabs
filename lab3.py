...
def generate_ElGamal_keys(global_keys):
    ...
    return [global_keys[0], global_keys[1], x, y]
def sign_ElGamal(m, keys):
    ...
    return [keys[0], keys[1], keys[2], keys[3], r, s]
...
def generate_GOST_keys(global_keys):
    ...
    return [global_keys[0], global_keys[1], global_keys[2], x, y]
...
def sign_GOST(m, keys):
    ...
    return [keys[0], keys[1], keys[2], keys[3], keys[4], r, s]
